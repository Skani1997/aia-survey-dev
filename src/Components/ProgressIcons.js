  ...
  return (
      <div>
          <div className="progress-container1">
              ...
              <ProgressIconBox img={Progress2} title="보고서 작성" description="최신화된 통계치 대차대조,전문가 제언 및 분석"></ProgressIconBox>

          </div>
          <div className="progress-container2">
          <ProgressIconBox img={Progress2} title="드림캘린더 완성" description="수령방법 선택"></ProgressIconBox>
          <ProgressIconBox img={Progress2} title="액션플랜 수행" description="서포터즈 면담 신청"></ProgressIconBox>
          </div>
      </div>
  );
}
